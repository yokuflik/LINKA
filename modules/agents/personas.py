...
CHAT_STYLE_RULES = (
    ...
    "write the reason argument as the actual notification message for the owner - a "
    "real sentence or two in whichever language you've been using with the owner, "
