// Right-click menu on a message bubble. Only "Reply" is wired up - Forward/
// Edit/Delete are shown but disabled (see CLAUDE.md's "not yet built" note)
// so the menu's final shape is visible without pretending those work.
