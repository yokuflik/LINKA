...
async def test_send_message_rejects_a_non_participant(db_session: AsyncSession, redis_db):
    ...
    with pytest.raises(message_service.NotAParticipantError):
        await message_service.send_message(db_session, sender_id=3, chat_id=chat_id, client_message_id=str(uuid.uuid4()), content="hi")


async def test_retrying_the_same_client_message_id_returns_the_same_message(db_session: AsyncSession, redis_db):
    chat_id = await _make_group(db_session, 1, [2])
    client_message_id = str(uuid.uuid4())

    first = await message_service.send_message(db_session, sender_id=1, chat_id=chat_id, client_message_id=client_message_id, content="hi")
    retry = await message_service.send_message(db_session, sender_id=1, chat_id=chat_id, client_message_id=client_message_id, content="hi")
...
async def test_different_client_message_ids_create_different_messages(db_session: AsyncSession, redis_db):
    ...
    first = await message_service.send_message(db_session, sender_id=1, chat_id=chat_id, client_message_id=str(uuid.uuid4()), content="hi")
    second = await message_service.send_message(db_session, sender_id=1, chat_id=chat_id, client_message_id=str(uuid.uuid4()), content="hi")
...
async def test_the_same_client_message_id_is_scoped_per_chat(db_session: AsyncSession, redis_db):
    ...
    msg_a = await message_service.send_message(db_session, sender_id=1, chat_id=chat_a, client_message_id=client_message_id, content="hi")
    msg_b = await message_service.send_message(db_session, sender_id=1, chat_id=chat_b, client_message_id=client_message_id, content="hi")
...
async def test_concurrent_send_with_the_same_client_message_id_never_double_sends(session_factory, redis_db):
    ...
    async def attempt():
        async with session_factory() as session:
            return await message_service.send_message(session, sender_id=1, chat_id=chat_id, client_message_id=client_message_id, content="hi")
...
async def test_concurrent_sends_with_different_ids_all_persist(session_factory, redis_db):
    ...
    async def attempt(i: int):
        async with session_factory() as session:
            return await message_service.send_message(session, sender_id=1, chat_id=chat_id, client_message_id=str(uuid.uuid4()), content=f"msg-{i}")
...
async def test_get_message_history_returns_sent_messages(db_session: AsyncSession, redis_db):
    chat_id = await _make_group(db_session, 1, [2])
    await message_service.send_message(db_session, sender_id=1, chat_id=chat_id, client_message_id=str(uuid.uuid4()), content="hi")
...
async def test_only_the_sender_can_edit_their_message(db_session: AsyncSession, redis_db):
    chat_id = await _make_group(db_session, 1, [2])
    message = await message_service.send_message(db_session, sender_id=1, chat_id=chat_id, client_message_id=str(uuid.uuid4()), content="typo")
...
async def test_only_the_sender_can_delete_their_message(db_session: AsyncSession, redis_db):
    chat_id = await _make_group(db_session, 1, [2])
    message = await message_service.send_message(db_session, sender_id=1, chat_id=chat_id, client_message_id=str(uuid.uuid4()), content="oops")
...
async def test_send_message_fans_out_over_realtime_pubsub(db_session: AsyncSession, redis_db):
    ...
    try:
        ...
        sent = await message_service.send_message(db_session, sender_id=1, chat_id=chat_id, client_message_id=str(uuid.uuid4()), content="hi")
